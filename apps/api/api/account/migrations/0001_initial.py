    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('affiliation_confirmed_at', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user'], name='idx_acc_usr_sdw_prd_acs_usr'), models.Index(fields=['user_sdwt_prod'], name='idx_acc_usr_sdw_prd_acs_1a1f0')],
                'constraints': [models.UniqueConstraint(fields=('user', 'user_sdwt_prod'), name='uniq_acc_usr_sdw_prd_acs_02885')],
            },
        ),
        migrations.CreateModel(
