...
export function L3SpiderDataSelector({
  ...
  // LINE_NAME mode: lineGroups maps lineName → (lineId, processIds[]) (전체 날짜, line_name→line_id 해석용)
  ...
  // Allowed process IDs: (line_name 모드) 선택 날짜에 그 line_name이 실제로 갖는 process 만.
