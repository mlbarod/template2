...
export const portalNavigationItems = [
  {
    ...
    items: compactItems([
      ...
      { title: "TTTM Spider", href: "/tttm_spider", appScope: "tttm-spider" },
      { title: "L3 Spider(개발중)", href: "/l3_spider", appScope: "l3-spider" },
      { title: "PM Spider(개발중)", href: "/pm_spider", appScope: "pm-spider" },
